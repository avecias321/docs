...
var ProductosService = /** @class */ (function () {
    ...
    ProductosService.prototype.cargarProductos = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.get('https://luis-c1961.firebaseio.com/productos_idx.json')
                .subscribe(function (resp) {
    ...
    ProductosService.prototype.buscarProducto = function (termino) {
        ...
        this.productosFiltrado = this.productos.filter(function (producto) {
            return true;
        });
...
module.exports = __webpack_require__(/*! C:\Users\LENOVO\desktop\docs\src\main.ts */"./src/main.ts");
